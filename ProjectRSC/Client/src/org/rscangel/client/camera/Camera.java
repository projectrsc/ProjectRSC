...
public class Camera {
	...
	public Camera(JagGraphics gameImage, int maxModels, int maxCameraModels, int k) {
		anInt374 = 50;
		...
		halfWidth = gameImage.gameWidth / 2;
		halfHeight = gameImage.gameHeight / 2;
	...
	public void finishCamera() {
		...
		for (int i4 = 0; i4 < cameraModelCount; i4++) {
			...
			if (model_2 == aModel_423) {
				...
				gameImage.drawVisibleEntity(l11 + halfWidth2, j12, i10, k10,
