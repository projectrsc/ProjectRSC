...
# ADD ANY NPCS THAT WILL BE USED FOR ANY QUEST OR HANDLER IN HERE

class Default(NpcInterface, TalkToNpcListener, TalkToNpcExecutiveListener):
    
    USABLE_NPCS = [1, 7, 11, 12, 26, 28, 33, 48, 54, 55, 56, 58, 59, 63, 69, 75, 82, 83, 84, 
                   85, 87, 88, 90, 93, 95, 101, 103, 105, 106, 115, 116, 125, 129, 130, 131, 
                   141, 142, 143, 144, 148, 149, 155, 156, 157, 160, 161, 163, 164, 165, 166, 167, 
