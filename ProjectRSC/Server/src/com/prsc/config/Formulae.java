...
import com.prsc.gs.external.ObjectFishDef;
import com.prsc.gs.external.ObjectMiningDef;
import com.prsc.gs.external.ObjectWoodcuttingDef;
import com.prsc.gs.external.SpellDef;
import com.prsc.gs.model.Entity;
...
public final class Formulae {
	 ...
	 */
	public static final java.awt.Point[][] F2PWILD_LOCS = {{new java.awt.Point(48, 96), new java.awt.Point(335, 141)} };
    public static final java.awt.Point[][] P2P_LOCS = { { new java.awt.Point(436, 432), new java.awt.Point(719, 906) }, { new java.awt.Point(48, 96), new java.awt.Point(335, 141) }, { new java.awt.Point(343, 567), new java.awt.Point(457, 432) }, { new java.awt.Point(203, 3206), new java.awt.Point(233, 3265) }, { new java.awt.Point(397, 525), new java.awt.Point(441, 579), }, { new java.awt.Point(431, 0), new java.awt.Point(1007, 1007) } };
		 ...
		 for (int i = 0; i < P2P_LOCS.length; i++) {
			 for (int ele = 0; ele < 4; ele++) {
				 if (location.getX() >= P2P_LOCS[i][0].getX() && location.getX() <= P2P_LOCS[i][1].getX()
						 && location.getY() >= P2P_LOCS[i][0].getY() + ((ele) * 944) && location.getY() <= P2P_LOCS[i][1].getY() + ((ele) * 944))
					 return false;
			 }
		 }
		 for (int i = 0; i < F2PWILD_LOCS.length; i++) {
			 for (int ele = 0; ele < 4; ele++) {
				 if (location.getX() >= F2PWILD_LOCS[i][0].getX() && location.getX() <= F2PWILD_LOCS[i][1].getX()
						 && location.getY() >= F2PWILD_LOCS[i][0].getY() + ((ele) * 944) && location.getY() <= F2PWILD_LOCS[i][1].getY() + ((ele) * 944)) {
					 return true;
				 }
			 }
		 }
