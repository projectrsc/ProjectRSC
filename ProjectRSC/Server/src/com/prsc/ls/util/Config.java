...
public class Config {
    ...
    public static String 
		RSCDLS_HOME, CONF_DIR, LOG_DIR, MYSQL_HOST, 
		MYSQL_TABLE_PREFIX, MYSQL_DB, MYSQL_USER, 
		MYSQL_PASS, LS_IP, QUERY_IP;

	/**
	 * the private key used when hashing incoming passwords
	 */
	public static String HASH_PRIVATE_KEY = "";
    ...
    public static void initConfig(String file) throws IOException {
		...
		HASH_PRIVATE_KEY = props.getProperty("hash_priv_key");
