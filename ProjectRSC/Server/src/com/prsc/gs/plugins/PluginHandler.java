...
public final class PluginHandler {
    ...
    public void initPlugins() throws Exception {
        ...
        pluginLocations.add("com.prsc.gs.plugins.quests");
        pluginLocations.add("com.prsc.gs.plugins.npcs");
        pluginLocations.add("com.prsc.gs.plugins.minigames");
        pluginLocations.add("com.prsc.gs.plugins.skills");
        pluginLocations.add("com.prsc.gs.plugins.commands");
        pluginLocations.add("com.prsc.gs.plugins.shops");
        pluginLocations.add("com.prsc.gs.plugins.misc");

        // Java class loading
        for (Class<?> interfce : loadInterfaces("com.prsc.gs.plugins.listeners.action")) {
        ...
        for (Class<?> interfce : loadInterfaces("com.prsc.gs.plugins.listeners.executive")) {
            String interfceName = interfce.getName().substring(interfce.getName().lastIndexOf(".") + 1);
            knownInterfaces.add(interfce);
