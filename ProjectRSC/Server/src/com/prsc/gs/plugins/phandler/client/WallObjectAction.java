    ...
    public void handlePacket(Packet p, Channel channel) throws Exception {
        try {
           ...
           // ActiveTile t = world.getTile(p.readShort(), p.readShort());
            int x = p.readShort();
            int y = p.readShort();
            final GameObject object =  player.getCurrentArea().getObject(x, y);
            ...
            World.getWorld().getDelayedEventHandler().add(new WalkToPointEvent(player, object.getLocation(), 1, false) {
                public void arrived() {
                    owner.resetPath();
                    DoorDef def = object.getDoorDef(); // || !owner.nextTo(object)
                    if (owner.isBusy() || owner.isRanging() || !owner.withinRange(object, 1) || def == null || owner.getStatus() != Action.USING_DOOR) {
                    	return;
                    }// /126
                    ...
                    if (PluginHandler.getPluginHandler().blockDefaultAction("WallObjectAction", new Object[]{object, click, owner})) {
                    	return;
                    }
                    ...
                    if (telePoint != null) {
                        ...
                        /*
                            ...
                            case 30: // Locked Doors
                                ...
                                break; */
                            /* case 20:
                                replaceGameObject(1, true, owner, object);
                                break;
                            case 1:
                                replaceGameObject(2, false, owner, object);
                                break;
                            case 2:
                                replaceGameObject(1, true, owner, object);
                                break; 
                            case 9:
                                replaceGameObject(8, false, owner, object);
                                break;
                            case 8:
                                replaceGameObject(9, true, owner, object);
                                break; 
               			*/
                            default:
                                owner.getActionSender().sendMessage("Nothing interesting happens.");
                ...
                private void doDoor() {
                	System.out.println("doDoor wallobjectaction");
