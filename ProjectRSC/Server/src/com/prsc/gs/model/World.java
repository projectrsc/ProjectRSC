...
public final class World {
	...
	private final Map<String, GameObject> objs = new HashMap<String, GameObject>(); // temporary
	...
	public void registerObjectCopy(GameObject obj) {
		String s = "" + obj.getX() + "," + obj.getY() + "";
		objs.put(s, obj);
	}
	
	public GameObject hasObject(int x, int y) {
		String s = "" + x + "," + y + "";
		return objs.get(s);
	}
