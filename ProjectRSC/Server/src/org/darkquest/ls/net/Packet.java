...
public class Packet {
     ...
     *
     * @param session The channel to associate with the packet
     * @param pData   The payload the packet
     */
    public Packet(Channel session, byte[] pData) {
     ...
     */
    public Packet(Channel session, byte[] pData, boolean bare) {
    ...
    /**
     * Returns the IO Channel associated with the packet, if any.
     *
     * @return The <code>Channel</code> object, or <code>null</code> if none.
     */
