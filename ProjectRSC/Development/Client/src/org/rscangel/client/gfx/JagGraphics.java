...
public class JagGraphics implements ImageProducer, ImageObserver {
	...
	public synchronized void addConsumer(ImageConsumer imageconsumer) {
		...
		imageconsumer.setDimensions(gameWidth, menuDefaultHeight);
	...
	public synchronized void completePixels() {
		...
		imageConsumer.setPixels(0, 0, gameWidth, menuDefaultHeight,
				colourModel, imagePixelArray, 0, gameWidth);
	...
	public void clearScreen() {
		int i = gameWidth * menuDefaultHeight;
		if (!interlace) {
			for (int j = 0; j < i; j++)
				imagePixelArray[j] = 0;
			return;
	...
	public void fadePixels() {
		int k = gameWidth * menuDefaultHeight;
		for (int j = 0; j < k; j++) {
