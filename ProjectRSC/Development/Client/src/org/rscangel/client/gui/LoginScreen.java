...
public final class LoginScreen {
	...
	//labels
	private int loginStatusLabelTop, loginStatusLabelBottom;
	...
	public void initialize() {
		...
		y = 230;
		loginStatusLabelTop = loginMenu.createTransparentLabel(256, y - 30, "", 4, true);
		loginStatusLabelBottom = loginMenu.createLabel(256, y - 10, "Please enter your username and password", 4, true);
		y += 28;
	...
	public void tick() {
		...
		case 0:
			...
			if (welcomeMenu.hasClicked(newUserButton)) {
				...
				loginStage = 2;
				loginMenu.setText(loginStatusLabelTop, "");
				loginMenu.setText(loginStatusLabelBottom, "Please enter your username and password");
	...
	public void updateLoginStatus(String top, String bottom) {
		if (loginStage == 2 && loginMenu != null) {
			loginMenu.setText(loginStatusLabelTop, top);
			loginMenu.setText(loginStatusLabelBottom, bottom);
		}
	}
